...
export const THEMES: Record<ThemeColor, ThemeConfig> = {
  ...
  rainbow: {
    ...
    backgroundGradient: ["#F5C8E8", "#D4B5F0", "#A8D5F2"],
    cardBackground: "#FFFFFF",
    cardBackgroundDark: "#9B7FD9",
    primary: "#B8A5E8",
    primaryDark: "#9B7FD9",
    secondary: "#D4B5F0",
    secondaryDark: "#B8A5E8",
    textPrimary: "#6B4FA0",
    textSecondary: "#8B6BBF",
    tabBarBackground: "#F5C8E8",
    tabBarActive: "#B8A5E8",
    tabBarInactive: "#D4B5F0",
    progressGradient: ["#D4B5F0", "#B8A5E8"],
    accentColor: "#9B7FD9",
    emoji: "🌈",
  },
  sunset: {
